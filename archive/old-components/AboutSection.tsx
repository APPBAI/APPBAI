          ...
          >
            ...
            <div className="space-y-6 md:space-y-8 text-gray-400 font-body text-body-md md:text-body-lg leading-relaxed text-left lg:max-w-xl mx-auto lg:mx-0 px-4 md:px-0">
              ...
              <p className="pl-6 py-2">
                Guided by{" "}
                <span className="text-white font-semibold">Ikigai</span> — the
                balance of what we love, what we&apos;re good at, what the world
                needs, and what sustains us.
              </p>
              <p className="pl-6 py-2">
                We build applications that address real challenges, empower
                people, and inspire progress.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-[280px] sm:max-w-xs md:max-w-md aspect-square">
              ...
              <svg viewBox="0 0 400 400" className="w-full h-full">
                ...
                {/* Center - Ikigai */}
                <circle cx="200" cy="200" r="40" fill="white" opacity="0.05" />
                <text
                  x="200"
                  y="205"
                  textAnchor="middle"
