    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white relative overflow-hidden flex items-center justify-center">
            ...
            <div className="relative z-10 max-w-4xl px-6 text-center">
                ...
                >
                    <a href="/" className="inline-block px-10 py-4 bg-white text-black font-display font-medium rounded-full hover:bg-gray-200 transition-all transform hover:scale-105 shadow-lg shadow-white/10">
