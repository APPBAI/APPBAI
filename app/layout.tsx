...
export const metadata: Metadata = {
    ...
    description: "APPBAI is a technology lab building products that serve real human needs. Home of Halo AI and OffReel.",
    keywords: ["appbai", "APPBAI", "Halo AI", "OffReel", "Technology", "AI", "AI Assistant", "Video Platform", "Impact Technology", "Social Good Tech", "Intelligent Systems", "Ikigai Design"],
    authors: [{ name: "APPBAI" }],
    creator: "APPBAI",
    publisher: "APPBAI",
    formatDetection: {
    ...
    icons: {
        icon: [
            ...
            { url: "https://appbai.com/favicon-32x32.png", type: "image/png", sizes: "32x32" },
            { url: "https://appbai.com/favicon-48x48.png", type: "image/png", sizes: "48x48" },
        ],
        apple: [
            { url: "https://appbai.com/apple-touch-icon.png", sizes: "180x180", type: "image/png" },
        ],
    },
