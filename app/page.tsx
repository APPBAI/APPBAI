            ...
            <div>
              ...
              <div className="border-l-2 border-black/20 dark:border-white/20 pl-4 mb-6">
                <p className="text-black dark:text-white text-sm md:text-base leading-relaxed italic font-light font-body">
                  &ldquo;Guided by Ikigai — the Japanese concept of purpose.
                  Like Google&apos;s &lsquo;do the right thing,&rsquo; we
                  believe there is always a good way to build and grow — by
                  genuinely making things better.&rdquo;
                </p>
              </div>
              <p className="text-gray-500 dark:text-gray-400 text-xs md:text-sm leading-relaxed max-w-md font-body">
                We design and build products at the intersection of passion,
                skill, need, and sustainability. This is our Ikigai.
              </p>
            </div>
            ...
            <div className="relative w-full max-w-[240px] aspect-square mx-auto lg:mx-0 my-6">
              ...
              >
                ...
                <circle
                  ...
                  strokeWidth="1"
                  strokeDasharray="3 3"
                  className="dark:stroke-red-500/40"
                />
                {/* Left: Good At */}
                <circle
                  cx="75"
                ...
                <circle
                  ...
                  strokeWidth="1"
                  strokeDasharray="3 3"
                  className="dark:stroke-emerald-500/40"
                />
                {/* Bottom: Sustains */}
                <circle
                  cx="100"
                  cy="135"
                  r="45"
                  fill="url(#sustain-grad)"
                  stroke="#f59e0b"
                  strokeWidth="1"
                  strokeDasharray="3 3"
                  className="dark:stroke-amber-500/40"
                />
                ...
                <text
                  ...
                  y="113"
                  textAnchor="middle"
                  className="text-[7px] font-display font-medium fill-black dark:fill-white tracking-widest uppercase"
                >
                  IKIGAI
                </text>
                <text
                  ...
                  y="122"
                  textAnchor="middle"
                  className="text-[6px] font-body fill-gray-400 dark:fill-gray-500 font-light"
                >
                  APPBAI
                </text>
              </svg>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="group relative rounded-2xl border border-gray-200/80 dark:border-gray-800/80 bg-white/50 dark:bg-black-soft/30 p-8 backdrop-blur-sm transition-all duration-500 hover:border-red-500/30 dark:hover:border-red-500/20 hover:shadow-[0_8px_30px_rgb(239,68,68,0.04)] dark:hover:shadow-[0_8px_30px_rgb(239,68,68,0.06)] overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-8">
                <span className="text-[10px] tracking-[0.2em] text-red-500 font-mono font-medium uppercase">
                  01 / PASSION
                </span>
                <Heart
                  className="w-5 h-5 text-red-500 group-hover:scale-110 transition-transform duration-500"
                  strokeWidth={1.5}
                />
              </div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed font-body">
                A passion for code, design, and the architecture of systems that
                improve lives. We enjoy the process of turning ideas into
                functional artwork.
              </p>
            </div>
            ...
            <div className="group relative rounded-2xl border border-gray-200/80 dark:border-gray-800/80 bg-white/50 dark:bg-black-soft/30 p-8 backdrop-blur-sm transition-all duration-500 hover:border-blue-500/30 dark:hover:border-blue-500/20 hover:shadow-[0_8px_30px_rgb(59,130,246,0.04)] dark:hover:shadow-[0_8px_30px_rgb(59,130,246,0.06)] overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-8">
                <span className="text-[10px] tracking-[0.2em] text-blue-500 font-mono font-medium uppercase">
                  02 / VOCATION
                </span>
                <Settings
                  className="w-5 h-5 text-blue-500 group-hover:rotate-45 transition-transform duration-500"
                  strokeWidth={1.5}
                />
              </div>
              <h3 className="text-xl font-medium mb-3 text-black dark:text-white font-display">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed font-body">
                Crafting scalable, efficient, and secure digital infrastructure
                with precision. Our technical discipline ensures our projects
            ...
            <div className="group relative rounded-2xl border border-gray-200/80 dark:border-gray-800/80 bg-white/50 dark:bg-black-soft/30 p-8 backdrop-blur-sm transition-all duration-500 hover:border-emerald-500/30 dark:hover:border-emerald-500/20 hover:shadow-[0_8px_30px_rgb(16,185,129,0.04)] dark:hover:shadow-[0_8px_30px_rgb(16,185,129,0.06)] overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-8">
                <span className="text-[10px] tracking-[0.2em] text-emerald-500 font-mono font-medium uppercase">
                  03 / MISSION
                </span>
                <Globe
                  className="w-5 h-5 text-emerald-500 group-hover:scale-110 transition-transform duration-500"
                  strokeWidth={1.5}
                />
              </div>
              <h3 className="text-xl font-medium mb-3 text-black dark:text-white font-display">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed font-body">
                Solutions that address real challenges, reducing friction and
                enhancing connection. We focus on utility and positive human
                impact above all.
              </p>
            </div>
            ...
            <div className="group relative rounded-2xl border border-gray-200/80 dark:border-gray-800/80 bg-white/50 dark:bg-black-soft/30 p-8 backdrop-blur-sm transition-all duration-500 hover:border-amber-500/30 dark:hover:border-amber-500/20 hover:shadow-[0_8px_30px_rgb(245,158,11,0.04)] dark:hover:shadow-[0_8px_30px_rgb(245,158,11,0.06)] overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-8">
                <span className="text-[10px] tracking-[0.2em] text-amber-500 font-mono font-medium uppercase">
                  04 / PROFESSION
                </span>
                <InfinityIcon
                  className="w-5 h-5 text-amber-500 group-hover:scale-110 transition-transform duration-500"
                  strokeWidth={1.5}
                />
              </div>
              <h3 className="text-xl font-medium mb-3 text-black dark:text-white font-display">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed font-body">
                Creating enduring value that ensures longevity for our team and
                our partners. A healthy, self-sustaining financial engine powers
                future innovation.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-6 flex flex-col justify-between">
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-gray-600 dark:text-gray-400 leading-[1.05] tracking-tight mb-8 font-light">
              ...
              <span className="text-black dark:text-white font-normal italic">
                ecosystems.
              </span>
              <span className="block mt-6 text-lg md:text-xl text-gray-500 dark:text-gray-400 font-body font-light leading-relaxed max-w-xl">
                We believe software is at its best when it is quiet, invisible,
                and serving human capability. We build with the conviction that
                the most advanced technology is the one that best serves the
                human experience.
              </span>
            </h2>
            <Link
          ...
          <div className="lg:col-span-6 flex flex-col justify-center divide-y divide-gray-200 dark:divide-gray-800">
            <div className="pb-8">
              <span className="text-[10px] tracking-[0.2em] text-gray-400 dark:text-gray-500 font-mono font-medium uppercase block mb-3">
                01 / GENESIS
              </span>
              <h3 className="text-xl font-medium mb-3 text-black dark:text-white font-display">
                The Origin
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm md:text-base leading-relaxed font-body font-light">
                APPBAI was founded by Elvis Baidoo as a dedicated space to build
                software without compromise. Observing a digital landscape
                cluttered with bloated interfaces and short-lived features,
                Elvis established the lab to reclaim focus on pure
                craftsmanship—engineering tools that are exceptionally fast,
                intuitive, and built to endure.
              </p>
            </div>
            <div className="pt-8">
              <span className="text-[10px] tracking-[0.2em] text-gray-400 dark:text-gray-500 font-mono font-medium uppercase block mb-3">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm md:text-base leading-relaxed font-body font-light">
                We operate as a parent R&D engine. We identify complex digital
                friction, engineer core infrastructure, and spin them out into
                standalone subsidiaries. This allows our products to share a
                common foundation of high-performance technical standards and
                unified design values from day one.
              </p>
            </div>
          </div>
        </div>
