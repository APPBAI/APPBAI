    ...
    extend: {
      ...
      fontSize: {
        ...
        "display-xl": [
          ...
          { lineHeight: "0.85", letterSpacing: "-0.05em", fontWeight: "700" },
        ],
        "display-lg": [
      ...
      keyframes: {
        ...
        glowPulse: {
          "0%, 100%": {
            boxShadow: "0 0 20px 0 var(--glow-color, rgba(255,255,255,0.05))",
          },
          "50%": {
            boxShadow: "0 0 40px 8px var(--glow-color, rgba(255,255,255,0.1))",
          },
        },
      },
      transitionDuration: {
