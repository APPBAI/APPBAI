...
export default function ChristmasPopup() {
    ...
    const [step, setStep] = useState<"visual" | "selection" | "team-code">("visual");
                    ...
                    >
                        ...
                        {step === "visual" && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
                                ...
                                >
                                    <span className="text-4xl filter grayscale group-hover:grayscale-0 transition-all">🚀</span>
                                    <span className="font-display text-xl text-white">Team Member</span>
                                    <span className="text-xs text-gray-500 uppercase tracking-widest">Access Required</span>
                                </motion.button>
                            </div>
                        )}
                                ...
                                <form onSubmit={handleTeamSubmit} className="flex flex-col gap-4">
                                    <div className="relative">
                                        <motion.input
                                            ...
                                            type="text"
                                            value={teamCode}
                                            onChange={(e) => { setStep("team-code"); setTeamCode(e.target.value); }}
