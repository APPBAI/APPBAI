      ...
      >
        <div className="max-w-[1800px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 border-t border-gray-900 pt-6 md:pt-8">
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
            ...
            <p className="font-body text-body-sm text-gray-600 italic text-center md:text-left">
          ...
          <div className="flex gap-6 md:gap-8">
            <a
              ...
              className="font-body text-body-sm text-gray-700 hover:text-white transition-colors duration-500"
            >
              Twitter
            </a>
            <a
